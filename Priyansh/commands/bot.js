...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "chutiya bot") || (event.body.toLowerCase() == "chutiye bot") || (event.body.toLowerCase() == "chumtiya bot") || (event.body.toLowerCase() == "chumtiye bot")) {
     return api.sendMessage("Hmm... ezat deni our leni har kesi ke bas ki bat nahhi 😾", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "hi") || (event.body.toLowerCase() == "hello") ||(event.body.toLowerCase() == "hlw") || (event.body.toLowerCase() == "helo")) {
     return api.sendMessage("Hello, Hi, Bye bye. nahii assalam alaikum,ALLAH HAFIZ,MASHA ALLAH,JAZZAK Allah,ALLAH HAFIZ KAHA KARO", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞  𓆩͙—͟͟͞͞𖣘𝐊𝐈𝐑𝐀⃟N 𓆩᭄͙̈  ☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖  𓆩͙—͟͟͞͞𖣘𝐊𝐈𝐑𝐀⃟N 𓆩᭄͙̈  🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞ https://www.facebook.com/profile.php?id=61577638905771 👋For Any Kind Of Help Contact On Telegram  Username 👉 𓆩͙—͟͟͞͞𖣘𝐊𝐈𝐑𝐀⃟N 𓆩᭄͙̈ 😇", threadID);
   };

   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("𓆩͙—͟͟͞͞𖣘𝐊𝐈𝐑𝐀⃟N 𓆩᭄͙̈❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Ladkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "lob you") || (event.body.toLowerCase() == "i lob you")) {
   ...
   if ((event.body.toLowerCase() == "&fuck") || (event.body.toLowerCase() == "&Fuck")) {
     return api.sendMessage("🏔️🏝️   𓆩͙—͟͟͞͞𖣘𝐊𝐈𝐑𝐀⃟N 𓆩᭄͙̈    Ƞɛ ꌗƥɛçɪɑɭɭɣ Ƭuɱ 🌊🪺Jɑɪʂɛ Ƭɧɑɽƙɪɣɵ Ƙɛ Ɬɪɣɛ•• 🏞️🌬️Ɣɑɧ çɵɱɱɑƞɗ Ɦɑʈɑ Ɗɪɣɑ Ɦɑɪ↗↘ Sɵɽɽɣ Ɠɣuʂ••😹🫶", threadID);
   };

  if ((event.body.toLowerCase() == "ami  𓆩͙—͟͟͞͞𖣘𝐊𝐈𝐑𝐀⃟N 𓆩᭄͙̈    ") || (event.body.toLowerCase() == "ami diya") || (event.body.toLowerCase() == "main amrita") || (event.body.toLowerCase() == "main priyansh") || (event.body.toLowerCase() == "main diya")) {
